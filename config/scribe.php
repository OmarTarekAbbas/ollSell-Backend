...
return [
     ...
     */
    'intro_text' => <<<INTRO
Welcome to the API documentation for the Dropshipping Platform. This documentation provides comprehensive details on the RESTful endpoints specifically designed to offer secure, fast, and convenient access to the platform's features. By integrating these APIs into your applications, you can effortlessly connect with dropshippers, manage products, handle orders, and set profit margins. This guide will help you understand the available endpoints and their functionalities, enabling you to develop innovative solutions for the dropshipping ecosystem..
The Dropshipping Platform APIs cover a wide range of functionalities to empower developers in building robust applications. Here are the major API categories available:

- Authentication:
    Authenticate and authorize users using OAuth2.0 security protocol. Obtain access tokens to make API requests on behalf of registered dropshippers.

- Users:
    Manage dropshippers' accounts, including registration, login, and profile updates.

- Categories:
    Retrieve a list of available product categories for dropshippers to explore.

- Products:
    Perform operations related to managing products within the platform. This includes listing, creating, updating, and deleting products.

- Orders:
    Enable dropshippers to handle orders efficiently. Use these endpoints to retrieve, create, update, and delete orders within the system.

...
class Updated extends BaseAction
{
    ...
    {  Log::error("Failed to update cfcf order ");
        // Log::info('Start:');
        // Log::channel('salla-order-api')->info($this->request);
        ...
        //         'customerCity' =>DB::table('translations')->where('category_type', 'Modules\CoreData\Entities\City')->
        //         where('value', 'like', '%' . $this->request->data['customer']['city'] . '%')->first()->category_id   ,
        ...
        //         'items'=>$request_items
        //     ]);
        //     $id =DropshipperMappingOrder::where('dropshipper_id',$dropshipper_id)

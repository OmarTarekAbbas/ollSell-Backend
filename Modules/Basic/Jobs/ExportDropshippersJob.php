...
use Modules\Acl\Exports\Dropshipper\DropshipperExport;
use Modules\CoreData\Actions\Notification\SendNotificationByAdminAction;
//todo change
class ExportDropshippersJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $filePath = 'exports/exportDropshippers_' . $timestamp . '.xlsx';

        // Generate Excel file
        Excel::store(new DropshipperExport($this->request),  $filePath);

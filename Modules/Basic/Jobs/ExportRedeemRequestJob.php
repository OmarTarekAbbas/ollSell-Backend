...
use Modules\Finance\Exports\RedeemRequest\RedeemRequestExport;

//todo change
class ExportRedeemRequestJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $filePath = 'exports/exportRedeemRequest_' . $timestamp . '.xlsx';

        // Generate Excel file
        Excel::store(new RedeemRequestExport($this->request),  $filePath);
        ...
        $content = json_encode([
            ...
            'ar' => 'التصدير جاهز! انقر أدناه للتنزيل .',
        ]);

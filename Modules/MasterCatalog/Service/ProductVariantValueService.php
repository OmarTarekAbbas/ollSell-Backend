...
use Modules\MasterCatalog\Repositories\ProductVariantValueRepository;
//todo change
class ProductVariantValueService extends BasicService
{
    protected $repo;
     ...
     * market service.
     * 
     * param ProductVariantValueRepository repository The  parameter is an instance of the
     * ProductVariantValueRepository class, which is responsible for handling database operations related to

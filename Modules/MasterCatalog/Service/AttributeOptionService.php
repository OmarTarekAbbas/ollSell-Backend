...
use Modules\MasterCatalog\Repositories\AttributeOptionRepository;
//todo change
class AttributeOptionService extends BasicService
{
    protected $repo;
     ...
     * market service.
     * 
     * param AttributeOptionRepository repository The  parameter is an instance of the
     * AttributeOptionRepository class, which is responsible for handling database operations related to

            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    ...
                    <div id="kt_app_content_container" class="app-container container-fluid">
                        ...
                        <form class="form d-flex flex-column flex-lg-row" action="{{ route('product.index') }}"
                            ...
                            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <select class="form-select mb-2" name="status" data-control="select2"
                                            ...
                                            <option {{ old('status') == '0' ? 'selected' : '' }} value="0">Not Published
                                            </option>
                                        </select>
                                        <!--end::Select2-->
                                        <!--begin::Description-->
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Select2-->
                                        <select class="form-select mb-2" name="category_Ids[]" multiple
                            ...
                            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                ...
                                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                           href="#kt_ecommerce_add_related_products">Related Product</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="card-body row pt-0">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <div class="text-muted fs-7">A product name is
                                                                required and recommended to be unique.
                                                            </div>
                                                            <!--end::Description-->
                                                        </div>
                                                        <!--end::Input group-->
                                                    ...
                                                    <div class="mt-5">
                                                        ...
                                                        <textarea name="description"
                                                                  id="kt_docs_ckeditor_classic_ar1">{{ Request::old('description') ? Request::old('description') : '' }}</textarea>
                                                    </div>
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid mb-2">
                                                            <input class="form-check-input" type="radio" value="1"
                                                                   name="is_wms" {{ old('is_wms') == 1 ? 'checked' : '' }} />
                                                            <label class="form-check-label">Yes</label>
                                                        </div>
                                                        <div class="form-check form-check-custom form-check-solid mb-2">
                                                            <input class="form-check-input" type="radio" value="0"
                                                                   name="is_wms" {{ old('is_wms') == 0 ? 'checked' : '' }} />
                                                        ...
                                                        <div class="card-title">
                                                            <label
                                                                ...
                                                                <input class="form-check-input custam_commission"
                                                                       type="checkbox"
                                                                       name="custam_commission" value="1"/>
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <div class="mb-10 row fv-row">
                                                        <div class="col">
                                                            ...
                                                            <input type="number" min="1" step=".01"
                                                                   name="supplier_price_cost" class="form-control mb-2"
                                                                   placeholder="Supplier Price"
                                                                   value="{{ old('supplier_price_cost') }}"/>
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                            <div class="text-muted fs-7">Set the product supplier
                                                                price.
                                                            </div>
                                                            <!--end::Description-->
                                                        </div>
                                                        ...
                                                        <div class="col-sm">
                                                            ...
                                                            <input type="number" min="0" readonly
                                                                   name="main_supplier_price_vat"
                                                                   class="form-control mb-2"
                                                                   id="supplier_price_vat"
                                                                   value="{{ old('main_supplier_price_vat') }}"/>
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                    <!--end::Input group-->
                                                    ...
                                                    <div class="mb-10 fv-row" id="pricing-map">
                                                        <div class="row">
                                                            <div class="col-sm">
                                                                <!--begin::Label-->
                                                                <label class="required form-label">Supplier
                                                                    Price</label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="number" min="0" readonly
                                                                       name="supplier_price" class="form-control mb-2"
                                                                       id="supplier_price"/>
                                                                <!--end::Input-->
                                                            </div>
                                                            {{-- <div class="col-sm"> --}}
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="hidden" min="0" readonly
                                                                   name="supplier_price_vat" class="form-control mb-2"
                                                                   id="supplier_price_vat"/>
                                                            <!--end::Input-->
                                                            {{-- </div> --}}
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="number" id="commission" readonly
                                                                       name="commission"
                                                                       class="form-control mb-2" step="0.01"
                                                                       max="1000.00"
                                                                       min="0.00" value="{{ old('commission') ?? 0 }}"/>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="col-sm">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--begin::Input-->
                                                                <input type="number" min="0" readonly
                                                                       name="vat_commission" class="form-control mb-2"
                                                                       value="{{ old('vat_commission') ?? 0 }}"/>
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="d-flex flex-column gap-7 gap-lg-10">
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <div class="fv-row mb-10">
                                                        ...
                                                        <div class="row row-cols-1 row-cols-md-3 row-cols-lg-1 row-cols-xl-3 g-9"
                                                            ...
                                                            <div class="col">
                                                                <!--begin::Option-->
                                                                <label
                                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary  d-flex text-start p-6 {{ old('is_discount') == 0 ? 'active' : '' }}"
                                                                        data-kt-button="true">
                                                                    <!--begin::Radio-->
                                                                    <span
                                                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                                <input class="form-check-input" id="no_discount_radio"
                                                                       type="radio" name="is_discount" value="0"
                                                                    {{ old('is_discount') == 0 ? 'checked' : '' }} />
                                                            </span>
                                                                    <!--end::Radio-->
                                                                    <!--begin::Info-->
                                                                    <span class="ms-5">
                                                            ...
                                                            <div class="col">
                                                                <!--begin::Option-->
                                                                <label
                                                                        class="btn btn-outline btn-outline-dashed btn-active-light-primary  d-flex text-start p-6 {{ old('is_discount') == 1 ? 'active' : '' }}"
                                                                        data-kt-button="true">
                                                                    <!--begin::Radio-->
                                                                    <span
                                                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                    ...
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="{{ old('is_discount') == 1 ? '' : 'd-none' }} row mb-10 fv-row"
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <input id="price_after_discount_input" type="number" min="1"
                                                                   step="0.01" name="priceAfterDiscount"
                                                                   class="form-control mb-2"
                                                                   placeholder="Supplier Price After Discount"
                                                                   value="{{ old('priceAfterDiscount') }}"/>
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                            <div class="text-muted fs-7">Set supplier product price
                                                                after
                                                                discount
                                                            </div>
                                                            <!--end::Description-->
                                                        ...
                                                        <div class="col-sm">
                                                            ...
                                                            <!--begin::Input-->
                                                            <input type="number" min="0" readonly
                                                                   name="discount_supplier_price_vat"
                                                                   class="form-control mb-2"
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <textarea name="product_meta_description"
                                                                  id="product_meta_description">{{ old('product_meta_description') }}</textarea>
                                    ...
                                    <!--end::Tab pane-->
                                    <!--begin::Tab pane-->
                                    <div class="tab-pane fade" id="kt_ecommerce_add_product_variations"
                                         role="tab-panel">
                                                ...
                                                <div class="card-header">
                                                    <div class="card-title">
                                                        <label class="form-check form-switch form-check-custom form-check-solid">
                                                            <input class="form-check-input variation-switcher"
                                                                   type="checkbox"
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <!--begin::Button-->
                                        <a href="{{ route('product.index',['is_wms'=>1]) }}"
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            ClassicEditor
                .create(document.querySelector('#kt_docs_ckeditor_classic_ar1'));
        ...
        $(document).ready(function () {
            ...
            const discountSupplierPriceVatInput = document.querySelector(
                'input[name="discount_supplier_price_vat"]');
            ...
            commissionInput.value = @json(old('commission')) ??
            0;
            ...
            function calculateCommissionAndVat() {
                ...
                if ((!selectedCategoryIds || selectedCategoryIds.length === 0) && $(
                    'input[name="custam_commission"]').prop('checked') == false) {
                    $('#commission').val(0);
                    return;
                }
            ...
            // category change the commission
            ...
            // Listen for changes in the selected categories
            $('select[name="category_Ids[]"]').change(function () {
                updateCalculations();
                calculateCommission();
                updateCalculations();
        ...
        // remove discount by radio
        // Listen for changes in the radio buttons
        // Trigger the change event on page load to initialize the state
        $('input[name="is_discount"]:checked').change();

        // Check if validation fails and priceAfterDiscount has a value
        @if ($errors->any() && old('priceAfterDiscount'))
        ...
        $('#price_after_discount_input').val("{{old('priceAfterDiscount')}}");
        updateCalculations();
        calculateCommission();
        updateCalculations();

...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_attribute_create" aria-expanded="true" aria-controls="kt_attribute_create">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Attribute</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form id="kt_attribute_create_form" class="form" method="post" action="{{route('attribute.store')}}">
            @csrf
            <!--begin::Card body-->
                                ...
                                <div data-repeater-item>
                                    <div class="form-group row mb-5">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="name" class="form-control mb-2 mb-md-0" placeholder="Enter name" />
                                        </div>
                                        <div class="col-md-6">
...
{{-- {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\Attribute\CreateRequest','#kt_attribute_create_form') !!} --}}

            ...
            <div class="card card-flush">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-users-table-filter="search"
                                class="form-control form-control-solid w-250px ps-15" placeholder="Search WareHouse"
                                onkeyup="search(this)" />
                        </div>
                        <!--end::Search-->
                    </div>
                    ...
                    <div class="card-toolbar">
                        @permission('create_warehouse')
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-select="base">
                                <!--begin::Add customer-->
                                <a href="{{ route('warehouse.create') }}" class="btn btn-primary"> Add Warehouse</a>
                                <!--end::Add customer-->
                            </div>
                        @endpermission
                        <!--end::Toolbar-->
                ...
                <div class="container">
                    <div class="card-body pt-0" id="main_table">
                        @include('mastercatalog::warehouses.table')
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    <script>
        var routeAll = "{{ route('warehouse.index', Request()->all()) }}";
        var route = "{{ route('warehouse.index') }}";

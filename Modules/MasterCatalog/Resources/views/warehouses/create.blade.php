...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form id="kt_user_create_form" class="form" method="post" action="{{route('warehouse.store')}}" enctype="multipart/form-data">
            @csrf
            <!--begin::Card body-->
...
<script>
    ...
    // Trigger the population of city options on page load

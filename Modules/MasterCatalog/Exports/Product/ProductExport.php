...
class ProductExport implements FromCollection, WithHeadings, WithStartRow
{
    public array $data;
    ...
    public function collection(): Collection
    {
        ...
        foreach ($this->data as $datum) {
            $data[] = [
                ...
                'Category_ID' => $datum[9],
                'Image' => $datum[5],
                // 'Target_Market' => $datum[9],
                // ' Recommended ' => $datum[10],
                // 'Has_Discount' => $datum[11],
                // 'Discounted_Price' => $datum[12],
                // "Has_Options" => $datum[13],
                // "Options" => $datum[14],
            ];
        }
        return collect($data);

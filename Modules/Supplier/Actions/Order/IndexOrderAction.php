...
class IndexOrderAction
{
    ...
    public function execute($request)
    {
        ...
        // $request->merge(["status_id" => OrderEnum::PREPARING_STATUS]); // TODO:: new status in majad
        ...
        if(isset($request['is_report']) && $request['is_report'])
        {
            ...
            if(isset($request['product_id']) && !empty($request['product_id']))
            {
                $recursiveRel['orderItems']['where'] = ['product_id' => $request['product_id'], 'supplier_id' => $request['supplier_id']];
            }
            ...
            {
                $recursiveRel['orderItems']['recursive']['product'][]['where'] = ['supplier_id' => $request['supplier_id']];
            }
        }

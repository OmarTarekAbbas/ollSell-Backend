            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                        ...
                        <a href="{{ route('supplier.order.export_supplier') }}" class="btn btn-flex btn-warning h-40px fs-7 fw-bold">
                        Export
                    </a>
                        <!--begin::Menu 1-->
                            ...
                            <div class="px-7 py-5" style="position: relative;top: 20px;">
                                ...
                                <div class="d-flex gap-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <!--begin::Options-->
                                        <div class="d-flex flex-column flex-wrap fw-semibold" data-kt-docs-table-filter="status_id ">
                                            <select class="form-select" aria-label="Default select status" name="statusId">
                                                <option selected>Open this select menu</option>
                                                @foreach ($status as $statu)
                                                <option value="{{ $statu->id }}">{{ $statu->name->value }}</option>
                                                @endforeach
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <!--begin::Options-->
                                        <div class="d-flex flex-column flex-wrap fw-semibold" data-kt-docs-table-filter="paymentMethod">
                                            <select class="form-select" aria-label="Default select payment method" name="paymentMethod">
                                                <option selected>Open this select menu</option>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" name="fromDate" id="exampleFormControlInput1">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label for="exampleFormControlTextarea1" class="form-label">To</label>
                                                    <input type="date" class="form-control" name="toDate" id="exampleFormControlTextarea1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <!--begin::Options-->
                                    <div class="d-flex flex-column flex-wrap fw-semibold" data-kt-docs-table-filter="deliveryDate">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label">From</label>
                                                    <input type="date" class="form-control" name="fromDeliveryDate" id="exampleFormControlInput1">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label for="exampleFormControlTextarea1" class="form-label">To</label>
                                                    <input type="date" class="form-control" name="toDeliveryDate" id="exampleFormControlTextarea1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    var route = "{{ Route('supplier.order.Logistics') }}";
    // Set gloabls vars
    let currency = "{{ currency() }}";
</script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js"></script>

<script src="{{ asset('dashboard2/assets/js/datatables/orderSuppliers.js') }}"></script>
<script>

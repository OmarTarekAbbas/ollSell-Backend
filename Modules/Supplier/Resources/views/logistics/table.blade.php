    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_orders_table" aria-describedby="kt_orders_table_info" style="width: 1028px;">
        ...
        <tbody class="fw-semibold text-gray-600">
            ...
            <tr class="odd">
                    ...
                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                        <p>
                            <div class="symbol-label">
                                <img src="{{ $order->dropshipper->avatar ?? 'https://cdn-icons-png.flaticon.com/512/3135/3135715.png' }}"  class="w-100" />
                            </div>
                        </p>
                    </div>
                    <!--end::Avatar-->
                ...
                <td>
                    <a href="{{route('supplier.order.show', $order->id)}}" type="button"

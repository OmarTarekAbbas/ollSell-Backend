                ...
                <form method="GET"  id="filterDataForm" action="#"
                    ...
                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                        <div class="mb-10 d-flex justify-content-between">
                            <select id="period_type" class="form-select" data-control="select2"
                                ...
                                <option></option>
                                <option value="today" @if(isset($request) && $request->period == 'today') selected @endif>Today</option>
                                <option value="this_week" @if(isset($request) &&$request->period == 'this_week') selected @endif>This
                                    Week
                                </option>
                                <option value="this_month" @if(isset($request) &&$request->period == 'this_month') selected @endif>This
                                    Month
                                </option>
                                <option value="this_year" @if(isset($request) &&$request->period == 'this_year') selected @endif>This
                                    Year
                                </option>
                                <option value="custom" @if(isset($request) &&$request->period == 'custom') selected @endif>Custom</option>
                            </select>
                        </div>
                    ...
                    <!--end::Input group-->
                        ...
                        <div class="d-flex justify-content-end ">
                            ...
                            <a href="{{ route('dashboard.report.performance.platform', ['period' => 'this_month']) }}"
                            ...
                            <button type="button" onclick="getFilter()" class="btn btn-primary fw-semibold px-6 filterDataForm"
...
@push('scripts')
    <script>
        ...
        function getFilter() {
            document.getElementById('filterDataForm').classList.remove("show");
            var params = {

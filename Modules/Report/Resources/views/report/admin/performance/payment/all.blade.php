...
@section('content')
                ...
                <div class="row" data-kt-user-table-filter="form">
                    ...
                    <div class="col-md-4">
                        <div class="d-flex justify-content-end ">
                            <a href="{{ route('dashboard.report.performance.payment', ['period' => 'this_month']) }}"
    ...
    <div class="card-body pt-0" id="data-table">
        @include('report::report.admin.performance.payment.mainContent')
    </div>
    </div>
    </div>
@endsection

<div class="row">
    <div class="col-xl-3" @can('view_product') onclick="getProduct()" @endcan >
    ...
    <div class="col-xl-3" @can('view_product') onclick="getLiveProduct(1)" @endcan>
        <div class="card card-click shadow-sm card-xl-stretch mb-xl-12">
            <!--begin: Statistics Widget 6-->
            <div class="card-header pt-5">
                <!--begin::Title-->
    ...
    <div class="col-xl-3" @can('view_product') onclick="getLiveProduct(0)" @endcan>
        <div class="card card-click shadow-sm card-xl-stretch mb-xl-12">
            <!--begin: Statistics Widget 6-->
            <div class="card-header pt-5">
                <!--begin::Title-->
    ...
    <div class="col-xl-3" @can('view_warehouse') onclick="getWarehouse()" @endcan>
        <div class="card card-click shadow-sm card-xl-stretch mb-xl-12">
            <!--begin: Statistics Widget 6-->
            <div class="card-header pt-5">
                <!--begin::Title-->
    ...
    <div class="col-xl-3" @can('view_suppliers') onclick="getSupplier()" @endcan>
        <div class="card card-click shadow-sm card-xl-stretch mb-xl-12">
            <!--begin: Statistics Widget 6-->
            <div class="card-header pt-5">
                <!--begin::Title-->
                <div class="card-title d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center">
                        <!--begin::Amount-->
                        <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{number_format($supplierCount)}}</span>
                        <!--end::Amount-->
                    </div>
                    <!--end::Info-->
                    <!--begin::Subtitle-->
                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Supplier</span>
                    <!--end::Subtitle-->
                </div>
                <!--end::Title-->
            </div>
    ...
    <div class="col-xl-3" @can('view_dropshipper') onclick="getDropshipper()" @endcan>
        <div class="card card-click shadow-sm card-xl-stretch mb-xl-12">
            <!--begin: Statistics Widget 6-->
            <div class="card-header pt-5">
                <!--begin::Title-->
    ...
    <div class="col-xl-3" @can('view_order') onclick="getOrder(0)" @endcan>
        <div class="card card-click shadow-sm card-xl-stretch mb-xl-12">
            <!--begin: Statistics Widget 6-->
            <div class="card-header pt-5">
                <!--begin::Title-->
        ...
        <div class="card shadow-sm card-xl-stretch mb-xl-12">
            ...
            <div class="card-header pt-5">
                ...
                <div class="card-title d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center">
                        <!--begin::Amount-->
                        <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{number_format($CODOrder)}}</span>
                        <!--end::Amount-->
                    </div>
                    <!--end::Info-->
                    <!--begin::Subtitle-->
                    <span class="text-gray-400 pt-1 fw-semibold fs-6">COD Order</span>
                    <!--end::Subtitle-->
                </div>
                <!--end::Title-->
            </div>
    ...
    @foreach($currentStatusOrder as $key => $value)
        <div class="col-xl-3" @can('view_order') onclick="getOrder({{$key}})" @endcan>
            <div class="card card-click shadow-sm card-xl-stretch mb-xl-12">
                <!--begin: Statistics Widget 6-->
                <div class="card-header pt-5">
                    <!--begin::Title-->

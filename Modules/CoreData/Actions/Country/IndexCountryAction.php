...
namespace Modules\CoreData\Actions\Country;
...
class IndexCountryAction
{
    ...
    public function execute()
    {
        ...
        return App(CountryRepository::class)->findBy($this->request, moreConditionForFirstLevel: $moreConditionForFirstLevel, pagination: true, perPage: $tableLength, recursiveRel: $recursiveRel, orderBy: ['column' => 'id', 'order' => 'desc']);
    }
}

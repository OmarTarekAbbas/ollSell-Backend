...
namespace Modules\CoreData\Actions\TargetMarket;

use Illuminate\Http\Request;
use Modules\CoreData\Repositories\TargetMarketRepository;

class IndexTargetMarketAction
{
    ...
    public function execute()
    {
        ...
        if (isset($this->request->status) && $this->request->status != "null") {
         ...
         return App(TargetMarketRepository::class)->findBy($this->request, moreConditionForFirstLevel: $moreConditionForFirstLevel, pagination: true, perPage: $tableLength, recursiveRel: $recursiveRel, orderBy: ['column' => 'id', 'order' => 'desc']);     
    }
}

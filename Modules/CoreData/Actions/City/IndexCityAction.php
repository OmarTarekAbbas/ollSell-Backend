...
namespace Modules\CoreData\Actions\City;
...
class IndexCityAction
{
    ...
    public function execute()
    {
        ...
        return App(CityRepository::class)->findBy($this->request, moreConditionForFirstLevel: $moreConditionForFirstLevel, pagination: true, perPage: $tableLength, recursiveRel: $recursiveRel, orderBy: ['column' => 'id', 'order' => 'desc']);      
    }
}

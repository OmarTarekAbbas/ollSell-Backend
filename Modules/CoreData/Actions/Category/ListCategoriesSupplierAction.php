...
class ListCategoriesSupplierAction
{
    ...
    public function execute()
    {
        ...
        $this->request->merge(['isApproved' => 0]);

        return App(CategoryRepository::class)->findBy($this->request, moreConditionForFirstLevel: $moreConditionForFirstLevel, pagination: true, perPage: $tableLength, recursiveRel: $recursiveRel, orderBy: ['column' => 'id', 'order' => 'desc']);       
    }
}

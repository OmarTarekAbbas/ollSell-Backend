...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_source_platform_edit" aria-expanded="true"
             aria-controls="kt_source_platform_edit">
            <!--begin::Card title-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_source_platform_edit_form" class="form" method="post" action="{{route('source_platform.update',$data->id)}}">
                @csrf
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route('source_platform.index') }}"
                       class="btn btn-light btn-active-light-primary me-2">Discard</a>
                    <button type="submit" class="btn btn-primary" id="kt_source_platform_edit_submit">Save Changes
                    </button>
                </div>
                <!--end::Actions-->
            </form>

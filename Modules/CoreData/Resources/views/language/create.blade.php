...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_language_create" aria-expanded="true"
             aria-controls="kt_language_create">
            <!--begin::Card title-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_language_create_form" class="form" method="post" action="{{route('language.store')}}"
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_language_create_submit">Save Changes
                    </button>
                </div>
                <!--end::Actions-->
            </form>

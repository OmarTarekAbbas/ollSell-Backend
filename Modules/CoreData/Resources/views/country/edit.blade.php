...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_country_edit" aria-expanded="true"
             aria-controls="kt_country_edit">
            <!--begin::Card title-->
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">country</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_country_edit_form" class="form" method="post" action="{{route('country.update',$data->id)}}"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-125px h-125px"
                                     style="background-image: url('{{ getFile($data->logo->file??null,pathType()['ip'],getFileNameServer($data->logo))  }}')"></div>
                                <!--end::Preview existing avatar-->
                                <!--begin::Label-->
                                <label
                                    class="btn btn-logo btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_country_edit_submit">Save Changes
                    </button>
                </div>
                <!--end::Actions-->
            </form>

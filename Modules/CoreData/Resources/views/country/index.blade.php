...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div class="card card-flush">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <span class="svg-icon svg-icon-1 position-absolute ms-6">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <rect opacountry="0.5" x="17.0365" y="15.1223" width="8.15546" height="2" rx="1"
                    ...
                    <!--end::Svg Icon-->
                    <input id="search" value="{{ request()->search }}" type="text" data-kt-country-table-filter="search"
                           class="form-control form-control-solid w-250px ps-15" placeholder="Search country"/>
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
        ...
        <div class="card-body pt-0" id="main_table">
            @include('coredata::country.table')
        </div>
    </div>
</div>
        @endsection
        @push('scripts')
            <script>
                ...
                var toggleActiveRoute = "{{ route('country.changeStatus') }}";
                var csrfToken = "{{ csrf_token() }}";
                var deletePermission = {{permissionShow('delete_country') ? 1 : 0}};
                var updatePermission = {{permissionShow('update_country') ? 1 : 0}};
            </script>
            <script src="{{ asset('dashboard') }}/assets/js/country/list.js?v=12"></script>

            <script>
                $('#search').on('keyup', function(){
                    // update URL 
                    full = routeAll;
                    if(full.substring(full.lastIndexOf('/') + 1) == 'country'){

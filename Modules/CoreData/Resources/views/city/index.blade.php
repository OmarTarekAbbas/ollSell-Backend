...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div class="card card-flush">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input id="search" type="text" data-kt-city-table-filter="search"
                           class="form-control form-control-solid w-250px ps-15" placeholder="Search city" value="{{request()->search}}"/>
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
        ...
        @push('scripts')
            <script>
                var routeAll = "{{ route('city.index', Request()->all()) }}";
                var route = "{{ route('city.index') }}";
                var toggleActiveRoute = "{{ route('city.changeStatus') }}";
                var csrfToken = "{{ csrf_token() }}";
                var deletePermission = {{permissionShow('delete_city') ? 1 : 0}};
                var updatePermission = {{permissionShow('update_city') ? 1 : 0}};
            </script>
            <script src="{{ asset('dashboard') }}/assets/js/city/list.js?v=2122"></script>

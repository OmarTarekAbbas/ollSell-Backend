...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_city_create" aria-expanded="true"
             aria-controls="kt_city_create">
            <!--begin::Card title-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_city_create_form" class="form" method="post" action="{{route('city.store')}}"
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{  route('city.index') }}" class="btn btn-light btn-active-light-primary me-2">Discard</a>

...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_category_create" aria-expanded="true" aria-controls="kt_category_create">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Suggested Category</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form id="kt_category_create_form" class="form" method="post" action="{{route('suggestedCategories.storeSuggested', $data->id)}}" enctype="multipart/form-data">
            @csrf
            <!--begin::Card body-->
                    ...
                    <div class="col">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="fv-row">
                                    <input type="text" name="name[{{$lang->code}}]" value="{{Request::old('name['.$lang->code.']') ?? $data->nameValue($lang)}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Name {{$lang->code}}" required />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                    ...
                    <div class="col">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="fv-row">
                                    <input type="text" name="metaTitle[{{$lang->code}}]" value="{{old('metaTitle['.$lang->code.']')}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Meta Title {{$lang->code}}" required />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                    ...
                    <div class="col">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="fv-row">
                                    <textarea type="text" rows="4" name="metaDescription[{{$lang->code}}]" value="{{Request::old('metaDescription['.$lang->code.']')}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Meta Description {{$lang->code}}" required></textarea>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <a href="{{route('suggestedCategories.listCategoriesSupplier')}}" class="btn btn-light btn-active-light-primary me-2">
                    Discard
                </a>
                @permission('update_categories')
                <button type="submit" class="btn btn-primary" id="kt_category_create_submit">
                    Approve Category
                </button>
                @endpermission

...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div class="card card-flush">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input id="search" type="text" data-kt-target_market-table-filter="search"
                           class="form-control form-control-solid w-250px ps-15" placeholder="Search Target market"/>
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-select="base">
                    @permission('create_target_market')
                    <!--begin::Add customer-->
                    <a href="{{ route('target_market.create') }}" class="btn btn-primary"> Add target market</a>
                    <!--end::Add customer-->
                    @endpermission
                </div>
                <!--end::Toolbar-->
        ...
        <div class="card-body pt-0" id="main_table">
            @include('coredata::target_market.table')
        </div>
    </div>
</div>
  @endsection
        @push('scripts')
            <script>
                var routeAll = "{{ route('target_market.index',Request()->all()) }}";
                var route = "{{ route('target_market.index') }}";
                var toggleActiveRoute = "{{ route('target_market.changeStatus') }}";
                var csrfToken = "{{ csrf_token() }}";
                var deletePermission = {{permissionShow('delete_target_market') ? 1 : 0}};
                var updatePermission = {{permissionShow('update_target_market') ? 1 : 0}};
            </script>
            <script src="{{ asset('dashboard') }}/assets/js/target_market/list.js?v=12"></script>

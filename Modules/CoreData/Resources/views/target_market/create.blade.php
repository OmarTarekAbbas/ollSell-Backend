...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_target_market_create" aria-expanded="true"
             aria-controls="kt_target_market_create">
            <!--begin::Card title-->
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">target Market</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_target_market_create_form" class="form" method="post" action="{{route('target_market.store')}}"
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{  route('target_market.index') }}" class="btn btn-light btn-active-light-primary me-2">Discard</a>
                    <button type="submit" class="btn btn-primary" id="kt_target_market_create_submit">Save Changes
                    </button>
                </div>
                <!--end::Actions-->
            </form>

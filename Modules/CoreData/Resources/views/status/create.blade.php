...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form id="kt_product_edit_form" class="form" method="post" action="{{route('status.store')}}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 fv-row">
                                <input type="text" name="name[{{$lang->code}}]" value="" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Name {{$lang->code}}" required />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->

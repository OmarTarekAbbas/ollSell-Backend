...
class FollowUpRepository extends BasicRepository
{
    /**
     * @var array
     */
    protected $fieldSearchable = [
        'order_id', 'user_id', 'activity_type', 'title', 'content', 'activity_date'
    ];
     ...
     */
    public function findBy(Request $request, $moreConditionForFirstLevel = [], $orderBy = [], $pagination = false, $perPage = 10, $get = '', $withRelations = [], $latest, $limit)
    {
        return $this->all($request->all(), moreConditionForFirstLevel: $moreConditionForFirstLevel, pagination: $pagination, perPage: $perPage, get: $get, recursiveRel: $withRelations, latest: $latest, limit: $limit);
    }

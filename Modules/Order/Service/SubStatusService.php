...
use Modules\Order\Repositories\SubStatusRepository;
use Modules\CoreData\Http\Resources\Status\StatusResource;

class SubStatusService extends BasicService
{
    protected $repo;
     ...
     * @return void
     */
    public function __construct(SubStatusRepository $repository)
    {

    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="row g-5 g-xl-12">
                ...
                <div class="col-xl-12">
                    <!--begin::Misc Widget 1-->
                    <div class="row mb-12 mb-xl-12 g-5 g-xl-12">
                        <!--begin::Col-->
                        <div class="col-4">
                            <!--begin::Card-->
                            <div class="card card-stretch">
                                ...
                                <a href="{{ route('setting.edit') }}"
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bold">olldrop Setting </span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->
                        ...
                        <div class="col-4">
                            ...
                            <div class="card card-stretch">
                                ...
                                <a href="{{ route('setting.shipping') }}"
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bold">shipping</span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->
                        ...
                        <div class="col-4">
                            ...
                            <div class="card card-stretch">
                                <!--begin::Link-->
                                <a href="{{ route('setting.order_setting') }}"
                                    class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bold">order Setting</span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->
                        ...
                        <div class="col-4">
                            ...
                            <div class="card card-stretch">
                                <!--begin::Link-->
                                <a href="{{ route('setting.salla_integration') }}"
                                    class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bold">Integration</span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->
                        ...
                        <div class="col-4">
                            ...
                            <div class="card card-stretch">
                                <!--begin::Link-->
                                <a href="{{ route('setting.aymakan_integration') }}"
                                    class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bold">Aymakan & WMS Integration</span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->
                        ...
                        <div class="col-4">
                            ...
                            <div class="card card-stretch">
                                <!--begin::Link-->
                                <a href="{{ route('setting.email_setting') }}"
                                    class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bold">Email Setting</span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->
                        ...
                        <div class="col-4">
                            ...
                            <div class="card card-stretch">
                                <!--begin::Link-->
                                <a href="{{ route('setting.ollops_setting') }}"
                                    class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-3x mb-5">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bold">Ollops Integration</span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->
                        ...
                        <div class="col-4">
                            ...
                            <div class="card card-stretch">
                                <!--begin::Link-->
                                <a href="{{ route('setting.dropshipper_setting') }}"
                                    class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-3x mb-5">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bold">Dropshipper Setting</span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->
                        ...
                        <div class="col-4">
                            ...
                            <div class="card card-stretch">
                                <!--begin::Link-->
                                <a href="{{ route('setting.listPay_setting') }}"
                                    class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-3x mb-5">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bold">Payment Setting</span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->

...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card card-flush overflow-auto">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end align-items-center"
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true"
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('log.request.index', Request()->all()) }}" method="get">
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                ...
                <div class="card-body pt-0" id="main_table">
                    @include('setting::log.request.table')
                </div>
                <!--end::Datatable-->
            </div>
            <!--end::Products-->
        ...
        @push('scripts')
            <script>
                var routeAll = "{{ route('log.request.index', Request()->all()) }}";
                var route = "{{ route('log.request.index') }}";

...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end align-items-center"
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true"
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('log.wms.index', Request()->all()) }}" method="get">
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        <div class="mb-10">
        ...
        @push('scripts')
            <script>
                var routeAll = "{{ route('log.wms.index', Request()->all()) }}";
                var route = "{{ route('log.wms.index') }}";

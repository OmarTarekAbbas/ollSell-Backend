...
class RequestLogRepository extends BasicRepository
{
    /**
     * @var array
     */
    protected $fieldSearchable = [
        'id','user_id', 'ip_address', 'method', 'url', 'request_body', 'response_status', 'response_time',
        'user_agent', 'referer','error','created_at'
    ];

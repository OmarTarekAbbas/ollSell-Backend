...
class SallaAuthService
{
     ...
     * return $this
     */
    public function forUser(Dropshipper $dropshipper)
    {
        $this->token = $dropshipper->sallatoken;
    ...
    public function request(string $method, string $url, array $options = [])
    {
        ...
        dd($this->provider->fetchResource($method, $url, $this->token->access_token, $options));

...
namespace Modules\Logistics\Actions\ShippingCompanyCityTime;

use Illuminate\Http\Request;
use Modules\Logistics\Repositories\ShippingCompanyCityTimeRepository;

class IndexShippingCompanyCityTimeAction
{
    protected $repo;
     ...
     * @return void
     */
    public function __construct(ShippingCompanyCityTimeRepository $repository)
    {
        //todo change

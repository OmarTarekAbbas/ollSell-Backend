...
namespace Modules\Logistics\Actions\ShippingCompanyVacation;

use Illuminate\Http\Request;
use Modules\Logistics\Repositories\ShippingCompanyVacationRepository;

class IndexShippingCompanyVacationAction
{
    protected $repo;
     ...
     * @return void
     */
    public function __construct(ShippingCompanyVacationRepository $repository)
    {
        //todo change

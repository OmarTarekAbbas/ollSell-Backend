...
namespace Modules\Logistics\Http\Resources\ShippingCompanyVacation;

use Illuminate\Http\Resources\Json\JsonResource;
use Modules\Logistics\Http\Resources\ShippingCompany\ShippingCompanyResource;

class ShippingCompanyVacationResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'shipping_company' => new ShippingCompanyResource($this->shipping_company),
        ];
    }
}

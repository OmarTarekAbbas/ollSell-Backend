...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_city_edit" aria-expanded="true"
             aria-controls="kt_city_edit">
            <!--begin::Card title-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_city_edit_form" class="form" method="post" action="{{route('shipping_company_city_time.update',$data->id)}}">
                @csrf
                    ...
                    <div class="col-lg-6 fv-row">
                        <select name="shipping_company_id" id="shipping_company_id"
                            ...
                            @foreach ($shippingcompanies as $value)
                                <option value="{{ $value->id }}"  @if($value->id==$data->shipping_company_id) selected @endif>
                                    {{ $value->name }}
                                </option>
                            @endforeach
                        </select>
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8">
                ...
                <div class="row">
                    <!--begin::Col-->
                    <div class="col-lg-6 fv-row">
                        <input type="text" name="number_hours" value="{{ $data->number_hours }}"
                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
            ...
            <!--end::Col-->
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route('shipping_company_city_time.index') }}"

        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card card-flush">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input id="search" type="text" class="form-control form-control-solid w-250px ps-15"
                                placeholder="Search shipping company Vacation" value="{{ request()->search }}" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-select="base">
                            @permission('create_shipping_company_vacation')
                                <!--begin::Add customer-->
                                <a href="{{ route('shipping_company_vacation.create') }}" class="btn btn-primary"> Add shipping
                                    company Vacation</a>
                                <!--end::Add customer-->
                            @endpermission
                        </div>
                ...
                <div class="card-body pt-0" id="main_table">
                    @include('logistics::shipping_company_vacation.table')
                </div>
            </div>
...
@push('scripts')
    <script>
        var routeAll = "{{ route('shipping_company_vacation.index', Request()->all()) }}";
        var route = "{{ route('shipping_company_vacation.index') }}";

        var csrfToken = "{{ csrf_token() }}";
        var deletePermission = {{ permissionShow('delete_shipping_company_vacation') ? 1 : 0 }};
        var updatePermission = {{ permissionShow('update_shipping_company_vacation') ? 1 : 0 }};
    </script>
    <script src="{{ asset('dashboard') }}/assets/js/shipping_company_vacation/list.js?v=2122"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#search').on('keyup', function() {
                ...
                // update URL 
                full = routeAll;
                if (full.substring(full.lastIndexOf('/') + 1) == 'shipping_company_vacation') {
        ...
        function handleDeleteRows() {
            ...
            const deleteButtons = document.querySelectorAll(
                '[data-kt-shipping_company_vacation-table-filter="delete_row"]'
            );
            if (deleteButtons) {

    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="row"  >
                    ...
                    <div class="col-md-4"style="padding: 20px;">
                        ...
                        <div class="d-flex flex-column flex-wrap fw-semibold"
                            ...
                            <select class="form-select" aria-label="Default select status" id="status"
                                onchange="getFilter()" name="status">
                                <option @if ('all' == $request->status) selected @endif value="all">All
                                </option>
                                <option @if ('internal' == $request->status) selected @endif value="internal">Internal
                                </option>
                                <option @if ('external' == $request->status) selected @endif value="external">External
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4"style="padding: 20px;">
                        <label class="form-label fs-6 fw-semibold"> Date Type :</label>
                        <div class="mb-10 d-flex justify-content-between">
                            <select id="type_date" class="form-select" onchange="getFilter()"
                                    data-placeholder="Select an option" name="type_date">
                                   <option value="created">Created At</option>
                                    <option value="validated">Shipped at  </option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-4"style="padding: 20px;">
                        ...
                        <div class="d-flex flex-column flex-wrap fw-semibold"
                            data-kt-docs-table-filter="status_id ">
                            <select class="form-select" aria-label="Default select status" id="paymentMethod"
                                onchange="getFilter()" name="paymentMethod">
                                <option @if ('all' == $request->paymentMethod) selected @endif value="">All
                                </option>
                                <option @if ('2' == $request->paymentMethod) selected @endif value="2">Cash on delivery
                                </option>
                                <option @if ('1' == $request->paymentMethod) selected @endif value="1">Online
                                </option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="card-body pt-0" id="data-table">
                @include('logistics::reportAymakan.mainContent')
            </div>
        </div>
    </div>
@endsection

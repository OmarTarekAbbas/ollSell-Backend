...
use Modules\Logistics\Repositories\ShippingCompanyRepository;
use Modules\Logistics\Actions\ShippingCompany\IndexShippingCompanyAction;
use Modules\Logistics\Http\Resources\ShippingCompany\ShippingCompanyListResource;

class ShippingCompanyService extends BasicService
{
    protected $repo;
    ...
    {
        return App(IndexShippingCompanyAction::class)->execute($request);
    }
    ...
    {
        return ShippingCompanyListResource::collection($this->repo->list($request, $pagination, $perPage, recursiveRel: ['city' => ['type' => 'whereHas']]));
    }
    ...
    {
        return ShippingCompanyListResource::collection(App(IndexShippingCompanyAction::class)->execute($request));
    }

...
use Modules\Logistics\Repositories\ShippingCompanyVacationRepository;
use Modules\Logistics\Actions\ShippingCompanyVacation\IndexShippingCompanyVacationAction;
use Modules\Logistics\Http\Resources\ShippingCompanyVacation\ShippingCompanyVacationResource;

class ShippingCompanyVacationService extends BasicService
{
     ...
     * information.
     */
    public function __construct(ShippingCompanyVacationRepository $repository, ShippingCompanyService $shipping_company_service)
    {
    ...
    {
        //todo change
        return App(IndexShippingCompanyVacationAction::class)->execute($request);
    }
    ...
    {
        return ShippingCompanyVacationResource::collection($this->repo->list($request, $pagination, $perPage));
    }

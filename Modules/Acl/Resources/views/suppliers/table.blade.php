        ...
        <tr>
            <td>
                <div class="form-check form-check-sm form-check-custom form-check-solid">
                    <input class="form-check-input" type="hidden" name="item_check" value="{{ $supplier->id }}" />
                </div>
            </td>
            <td><p>{{ $supplier->name }}</p></td>
            <td><p>{{ $supplier->email }}</p></td>
            @canany(['update_suppliers','delete_suppliers','view_suppliers'])​
                    ...
                    <div class="users-list-actions menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            @permission('view_suppliers')
                                <a href="{{ route('suppliers.show', $supplier->id) }}" class="menu-link px-3">View</a>
                            @endpermission
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            @permission('update_suppliers')
                                <a href="{{ route('suppliers.edit', $supplier->id) }}" class="menu-link px-3">Edit</a>
                            @endpermission
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->

...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_user_create_form" class="form" method="post" action="{{route('suppliers.store')}}"
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{  route('suppliers.index') }}" class="btn btn-light btn-active-light-primary me-2">Discard</a>

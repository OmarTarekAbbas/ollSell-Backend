    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">Supplier</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_user_edit_form" class="form" method="post" action="{{route('suppliers.update',$data->id)}}"
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="@if(user()->can('view_suppliers')){{ route('suppliers.index') }} @else {{ route('dashboard') }}@endif" class="btn btn-light btn-active-light-primary me-2">Discard</a>
...
@push('scripts')
    <script>
        ...
        let route = "{{ route('suppliers.index') }}";

                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5">
                                                ...
                                                @foreach ($models as $model)
                                                    ...
                                                    <tr>
                                                        <!--begin::Label-->
                                                        <td class="sticky-cell text-gray-800">{{ ucwords(str_replace('_', ' ', $model)) }}
                                                        </td>
                                                        <!--end::Label-->
                                                        <!--begin::Options-->
                                                        <td>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="{{ route('user.show', $user->id) }}">
                                            <div
                                                class="symbol-label fs-3 bg-light-danger text-danger">{{ substr($user->name, 0, 1) }}</div>
                                        </a>
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::User details-->
...
@push('scripts')
    <script>
        var route = "{{ route('role.store') }}";
        var csrfToken = "{{ csrf_token() }}";
    </script>
    <script src="{{ asset('dashboard/') }}/assets/js/custom/apps/user-management/roles/view/view.js"></script>
    <script src="{{ asset('dashboard/') }}/assets/js/custom/apps/user-management/roles/view/update-role.js"></script>
@endpush

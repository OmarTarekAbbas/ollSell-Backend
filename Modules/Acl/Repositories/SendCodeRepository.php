...
class SendCodeRepository extends BasicRepository
{
    /**
     * @var array
     */
    protected $fieldSearchable = [
        'id', 'code',  'dropshipper_id', 'expireResendCodeAt'
    ];
     ...
     * sent in the HTTP request. It can contain data from the request body, query parameters, headers,
     * etc. In this case, it is used to retrieve the data sent in the request to create or update a
     * resource.

...
class DropshipperPaymentRepository extends BasicRepository
{
    /**
     * @var array
     */
    protected $fieldSearchable = [
        'id',  'dropshipper_id', 'bank_name', 'bank_address', 'swift_number', 'beneficiary_name', 'beneficiary_address',
    ...
    {
        return DropshipperPayment::class;
    }

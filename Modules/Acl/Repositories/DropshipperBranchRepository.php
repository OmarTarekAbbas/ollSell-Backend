...
class DropshipperBranchRepository extends BasicRepository
{
    /**
     * @var array
     */
    protected $fieldSearchable = [
        'company_name', 'email_address', 'address', 'city', 'state', 'main', 'dropshipper_id'
    ];
    ...
    {
        return DropshipperBranch::class;
    }

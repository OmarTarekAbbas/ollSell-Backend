...
class UserRepository extends BasicRepository
{
     ...
     */
    public function findBy(Request $request, $withRelations = [], $moreConditionForFirstLevel = [], $pagination = false, $perPage = 10, $recursiveRel = [])
    {
        return $this->all($request->all(), withRelations: $withRelations, moreConditionForFirstLevel: $moreConditionForFirstLevel, pagination: $pagination, perPage: $perPage, recursiveRel: $recursiveRel);
    }
